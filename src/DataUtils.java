...
class DataPacket<T> {
    private T content;
    public DataPacket(T content) { this.content = content; }
...
public class DataUtils {
    ...
    public static List<Map<String, Object>> parseJson(String json) {
        ...
        for (String obj : objects) {
            ...
            String[] keys = { "name", "price", "area_sqm", "rooms", "year_built", "city", "province", "floor", "parking", "garden", "image", "score", "for_sale", "type" };
            for (String key : keys) {
    ...
    public static String extractValue(String json, String key) {
        ...
        int ve = vs;
        while (ve < json.length() && json.charAt(ve) != ',' && json.charAt(ve) != '}' && json.charAt(ve) != ']') ve++;
